        ...
        <div className="flex-1 flex flex-col lg:flex-row overflow-hidden">
              ...
              <section>
                ...
                <div className="bg-white p-4 rounded-xl border border-gray-100 space-y-3 shadow-sm">
                  <div className="flex justify-between items-center">
                    ...
                    <span
                      className={`px-2 py-1 rounded-lg text-[9px] uppercase font-black tracking-tighter border ${status === "pending" ? "bg-amber-50 text-amber-600 border-amber-100" : status === "cancelled" ? "bg-rose-50 text-rose-600 border-rose-100" : "bg-emerald-50 text-emerald-600 border-emerald-100"}`}
                    >
                      {status}
                    </span>
                  </div>
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            <div className="p-4 border-b border-gray-50 flex justify-between items-center bg-white sticky top-0 z-10">
              <h2 className="font-bold text-gray-700 uppercase text-[10px] tracking-widest">
                Items Ordered
              </h2>
              <span className="text-[10px] bg-indigo-50 px-2 py-1 rounded text-indigo-600 font-bold">
                {order.products.length} SKU
              </span>
            </div>
            <div className="flex-1 overflow-y-auto p-4 custom-scrollbar space-y-3 bg-gray-50/10 print:bg-white">
              {order.products.map((p, i) => (
                <div
                  key={i}
                  className="flex items-center justify-between p-3 bg-white rounded-xl border border-gray-100 print:border-b print:rounded-none"
                >
