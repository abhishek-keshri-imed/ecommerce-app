            ...
            {filteredUsers.map((user) => (
              ...
              >
                <div className="relative shrink-0">
                  ...
                  <span
                    className={`absolute -bottom-1 -right-1 w-4 h-4 border-2 border-white rounded-full ${user.status === "online" ? "bg-green-500" : "bg-gray-300"}`}
                  ></span>
                </div>
            ...
            <>
              ...
              <div className="px-6 py-4 border-b border-gray-100 bg-white flex items-center gap-4 shrink-0 shadow-sm z-10">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-1.5">
                    <div
                      className={`w-2 h-2 rounded-full ${activeChat.status === "online" ? "bg-green-500" : "bg-gray-300"}`}
                    ></div>
              ...
              >
                {activeChat.messages.map((msg, i) => (
                  ...
                  >
                    <div
                      className={`max-w-[75%] p-3.5 rounded-2xl text-sm shadow-sm leading-relaxed ${
                        msg.sender === "seller"
              ...
              <div className="p-4 bg-white border-t border-gray-100 shrink-0">
                <form
                  ...
                  className="flex items-center gap-3 bg-gray-50 rounded-2xl px-4 py-2 border border-gray-100 focus-within:border-indigo-400 focus-within:bg-white transition-all shadow-inner"
                >
                  <input
                    type="text"
                    value={inputText}
                  ...
                  <button
                    type="submit"
                    className="bg-indigo-600 text-white p-2.5 rounded-xl hover:bg-indigo-700 hover:scale-105 transition-all shadow-lg shadow-indigo-100"
                  >
                    <svg
